import preview from "../res/icons/smartphone.png";
let i = 0;
...
export var phones = [
  {
    ...
    model: "Mortal",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare ipsum in fermentum venenatis. Suspendisse.",
    version: "X",
    price: "500$",
    discount: "20%",
    soldOut: false,
